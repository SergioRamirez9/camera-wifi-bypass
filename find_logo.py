...
def main():
    try:
        ...
        print("\n=== Search for logo files on camera filesystem ===")
        # Search for files with logo or splash in their names, or common image extensions
        print(run_command(s, "find / -name *logo* -o -name *splash* -o -name *.bmp -o -name *.png -o -name *.jpg 2>/dev/null"))
        
        print("\n=== Check bootconfig files ===")
        print(run_command(s, "ls -la /bootconfig/"))
        print(run_command(s, "ls -la /bootconfig/bin/"))
