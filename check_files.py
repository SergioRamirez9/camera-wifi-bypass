...
def main():
    try:
        ...
        print("\n=== Check mmc mount content ===")
        print(run_command(s, "ls -la /mnt/mmc/"))
        
        print("\n=== Check DCIM directory content ===")
        print(run_command(s, "ls -la /mnt/mmc/DCIM/"))
        
        print("\n=== Check files.txt content ===")
        print(run_command(s, "cat /customer/wifi/webserver/www/files.txt"))
        
        print("\n=== Check find output ===")
        print(run_command(s, "find /mnt/mmc/DCIM -type f"))
