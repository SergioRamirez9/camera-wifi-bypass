...
def main():
    try:
        ...
        print("\n=== nvconf help ===")
        print(run_command(s, "nvconf"))
        print(run_command(s, "nvconf -h"))
        print(run_command(s, "nvconf --help"))
        
        print("\n=== Let's try to dump nvram using nvconf ===")
        print(run_command(s, "nvconf dump"))
        print(run_command(s, "nvconf list"))
        print(run_command(s, "nvconf show"))
        print(run_command(s, "nvconf print"))
