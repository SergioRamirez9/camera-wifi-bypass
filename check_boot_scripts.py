...
def main():
    try:
        ...
        print(run_command(s, "cat /sys/devices/system/cpu/cpufreq/policy0/scaling_governor"))
        
        print("\n=== Available Governors ===")
        print(run_command(s, "cat /sys/devices/system/cpu/cpufreq/policy0/scaling_available_governors"))
        
        print("\n=== Content of /customer/wifi/run_goahead.sh ===")
        print(run_command(s, "cat /customer/wifi/run_goahead.sh"))
        
        print("\n=== Content of /customer/wifi/rcInsDriver.sh ===")
        print(run_command(s, "cat /customer/wifi/rcInsDriver.sh"))
