...
def main():
    try:
        ...
        print("\n=== Dumping CGI Parameters (nvconf show 0) ===")
        print(run_command(s, "nvconf show 0", wait_time=8.0))
        
        print("\n=== Dumping Network Parameters (nvconf show 1) ===")
        print(run_command(s, "nvconf show 1", wait_time=8.0))
